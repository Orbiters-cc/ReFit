...
ROOT_FILES = ("README.md", "package.json", "blackorbit.png", "kofi_symbol.png", "kofi_symbol.svg")
...
def main():
    parser = argparse.ArgumentParser(description="Build the explicit ReFit package release file list.")
